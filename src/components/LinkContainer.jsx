    ...
    return (
        <div class="p-9 bg-purple-100 rounded-2xl relative shadow-lg" key={link.id}>
            ...
            <a class="absolute top-3 right-8" onClick={() => copyLink(link.url)} title="Copy link to clipboard">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 absolute top-1 right-1 stroke-gray-500 hover:stroke-gray-700 cursor-pointer">
            ...
            <a class="absolute top-3 right-3" onClick={() => deleteLink(link.id)} title="Delete link">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 absolute top-1 right-1 stroke-gray-500 hover:stroke-gray-700 hover:stroke-gray-700 cursor-pointer">
